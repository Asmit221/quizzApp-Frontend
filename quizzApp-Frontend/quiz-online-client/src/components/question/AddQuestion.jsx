...
const AddQuestion = () => {
	...
	const handleAddChoice = () => {
		const lastChoice = choices[choices.length - 1]                                           /*option handling logic */
							...
							<form onSubmit={handleSubmit} className="p-2">
								...
								<div className="mb-3">
									...
									<select
										id="question-type"
										value={questionType}
										onChange={(event) => setQuestionType(event.target.value)}          /*Question Type selection */
										className="form-control">
